          ...
          <div ref={infoRef} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Sahilsgt010@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-secondary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+91 9812852757</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                  <GithubLogo size={20} className="text-primary-foreground" />
                </a>
                <a href="https://linkedin.com/in/sahil3785" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
