        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Building automation-driven systems and scalable integrations through API-driven workflows, modern frontend development, and reliable system integrations.
            </p>
            <div className="flex gap-4">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                <GithubLogo size={18} className="text-primary-foreground" />
              </a>
              <a href="https://linkedin.com/in/sahil3785" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
