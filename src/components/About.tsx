...
import { Globe, Code, Lightning, Rocket, Heart, Database, GitBranch, Cube, Terminal, Cloud, Plug, Gear } from 'phosphor-react';
...
const About = () => {
  ...
  const skills = [
    { icon: Code, name: 'React', level: 90 },
    { icon: Rocket, name: 'Next.js', level: 85 },
    { icon: Lightning, name: 'Tailwind CSS', level: 88 },
    { icon: Code, name: 'JavaScript', level: 90 },
    { icon: Code, name: 'TypeScript', level: 85 },
    { icon: GitBranch, name: 'GitHub', level: 88 },
    { icon: Plug, name: 'REST APIs', level: 90 },
    { icon: Plug, name: 'Webhooks', level: 88 },
    { icon: Gear, name: 'N8N', level: 85 },
    { icon: Gear, name: 'Trigger.dev', level: 85 },
    { icon: Database, name: 'Supabase', level: 87 },
    { icon: Database, name: 'Airtable', level: 87 },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-80 h-80 mx-auto lg:mx-0">
              ...
              <div className="relative w-full h-full glass rounded-full p-2 hover:shadow-glow-primary transition-all duration-500 group">
                <div className="w-full h-full cursor-pointer rounded-full overflow-hidden bg-gradient-secondary">
                  <img src="/Images/profileLogo.jpg" alt="SAHIL - Frontend & Automation Developer" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
              </div>
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I'm an Automation-focused Software Developer with hands-on experience building API-driven systems, automation workflows, and scalable integrations. Skilled in React, JavaScript/TypeScript, and backend-connected platforms such as Supabase and Airtable. Experienced in designing webhook-based workflows, integrating third-party SaaS tools, automating data pipelines, and maintaining reliable, secure system flows.
            </p>

            <p className="text-lg text-muted-foreground leading-relaxed">
              Comfortable owning features end-to-end—from design to production—while collaborating across product and engineering teams. I'm passionate about solving real-world problems with practical, efficient automation solutions that improve system efficiency and reduce manual operations.
            </p>
