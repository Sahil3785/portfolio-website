      ...
      <div className="container mx-auto max-w-7xl">
        <div ref={titleRef} className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A curated collection of automation and development projects demonstrating my expertise in building API-driven systems, workflow automation, and scalable integrations — from frontend interfaces to backend automation pipelines.          </p>
        </div>
